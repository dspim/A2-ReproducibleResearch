...
knitr::opts_chunk$set(comment="", message=FALSE, warning=FALSE,eval=FALSE)
library(knitr)
library(shiny)
library(rmarkdown)
library(ggplot2)
...
3. download [global.R](https://dl.dropboxusercontent.com/u/68133220/DSP/global.R) for 編碼支援  
4. 程式內部除了註解不能放有中文字內容   
